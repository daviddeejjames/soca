				...
				<div id="inner-footer" class="wrap cf">
					...
					<div class="social">
						...
						?>
							...
							<a href="<?php echo $fb_link; ?>" target="_blank" class="social fb">
						...
						<?php
							...
							{ 
						?>
							<a href="<?php echo $insta_link; ?>" target="_blank" class="social insta">
						...
						<?php
							...
							{ 
						?>
							<a href="<?php echo $twitter_link; ?>" target="_blank" class="social twitter">
